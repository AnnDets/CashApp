...
ALTER TABLE accounts
    ADD CONSTRAINT FK_ACCOUNTS_ON_USER FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;

ALTER TABLE categories
    ADD CONSTRAINT FK_CATEGORIES_ON_AUTHOR FOREIGN KEY (author_id) REFERENCES users (id) ON DELETE CASCADE;
...
ALTER TABLE operations
    ADD CONSTRAINT FK_OPERATIONS_ON_USER FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;

ALTER TABLE operations
    ADD CONSTRAINT FK_OPERATIONS_ON_ACCOUNT_INCOME FOREIGN KEY (account_income_id) REFERENCES accounts (id) ON DELETE SET NULL;

ALTER TABLE operations
    ADD CONSTRAINT FK_OPERATIONS_ON_ACCOUNT_OUTCOME FOREIGN KEY (account_outcome_id) REFERENCES accounts (id) ON DELETE SET NULL;

ALTER TABLE operations
    ADD CONSTRAINT FK_OPERATIONS_ON_CATEGORY FOREIGN KEY (category_id) REFERENCES categories (id) ON DELETE SET NULL;

ALTER TABLE operations
    ADD CONSTRAINT FK_OPERATIONS_ON_PLACE FOREIGN KEY (place_id) REFERENCES places (id) ON DELETE SET NULL;

ALTER TABLE places
    ADD CONSTRAINT FK_PLACES_ON_AUTHOR FOREIGN KEY (author_id) REFERENCES users (id) ON DELETE CASCADE;