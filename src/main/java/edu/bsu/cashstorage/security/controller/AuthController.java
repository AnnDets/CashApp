...
public class AuthController {
    ...
    public AuthResponseDTO login(@RequestBody AuthRequestDTO authRequestDTO) {
        return authService.login(userMapper.toEntity(authRequestDTO));
    }
    ...
    public AuthResponseDTO register(@RequestBody RegisterRequestDTO registerRequestDTO) {
        return authService.register(userMapper.toEntity(registerRequestDTO));
    }

    @PatchMapping(APIs.Server.CHANGE_PASSWORD)
    public AuthResponseDTO changePassword(@RequestBody ChangePasswordDTO changePasswordDTO) {
